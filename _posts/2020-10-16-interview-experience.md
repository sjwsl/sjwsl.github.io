...
英文介绍下自己，主要介绍技术方面。然后英文简单交流一下。

**项目**

实习经历。聊到了在腾讯做的浮点向量点乘优化，AVX 指令集相关。在此基础上问我知不知道 CUDA，我说听说过但不了解。面试官简单给我介绍了下，之后问我为什么 GPU 用来做大规模计算。结合图形学的知识，主要是因为 GPU 的核心多，可以做简单的并行运算。
