...
大三下的日常实习我只投了 N 厂，主要是学期末太忙，还要准备 Google 的面试。面试的体验除了太长都挺好的，没太有八股文，C++ 和操作系统的问题都比较深，有些问题我答得也不好。面试官都很关注我的能力、兴趣和他们的工作是否 match，最后一面大 boss 又详细介绍了他们的各种工作，反复确认我是否真的感兴趣。于是其他厂也懒得投了，又拒掉了之前答应的字节（不想 996），接了 N 厂的 offer。工作主要会是 C++，做用于 GPU 测试的不同层次 simulator。N 厂的 C++ 水平应该还是不错的（面试官说生产环境会用到 C++17），希望能学到些东西。实习待遇说实话有点差（我待过的最低工资），本硕博区别对待，但很舒服，标准的 965。
