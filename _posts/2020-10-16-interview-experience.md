...
多线程大量 malloc 效率低，怎么办？实现一个自己的内存分配器，减少内存分配次数。大概讲了一下我的实现思路，面试官追问我如何应对多线程的问题，我说除了加锁可以参考 vector 预分配空间后线程安全的读写方法。
